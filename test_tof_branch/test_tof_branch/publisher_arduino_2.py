...
class ArduinoTOF2Publisher(Node):
    
    def __init__(self): 
        super().__init__(node_name = 'tof_pub_2')
        self.publisher_ = self.create_publisher(String,'arduino2',10)
...
def main(args=None):
    ...
    arduino_publisher_2 = ArduinoTOF2Publisher()

    rclpy.spin(arduino_publisher_2)
